...
- Fix component-release workflow: remove intermediate release branch push blocked by repo rulesets [`#509`](https://github.com/rdkcentral/sysint/pull/509)
- Fix git-flow init failure: use feature/main-dummy as production branch [`#508`](https://github.com/rdkcentral/sysint/pull/508)
- Create test_file [`#507`](https://github.com/rdkcentral/sysint/pull/507)
- fix: initialize git-flow before release start in component-release workflow [`#506`](https://github.com/rdkcentral/sysint/pull/506)
- Delete test_file [`#505`](https://github.com/rdkcentral/sysint/pull/505)
- refactor(component-release): remove git-flow and RDKCM_RDKE secret, release directly on feature/component-release [`#504`](https://github.com/rdkcentral/sysint/pull/504)
- Create test_file [`#503`](https://github.com/rdkcentral/sysint/pull/503)
- RDKEMW-16664: Send integer value for MemAvailable to t2ValNotify [`#496`](https://github.com/rdkcentral/sysint/pull/496)
- Create component-release.yml [`781c52e`](https://github.com/rdkcentral/sysint/commit/781c52e931e32a1c66b7805218b67511af99f9c2)
- Update component-release.yml [`7600eaf`](https://github.com/rdkcentral/sysint/commit/7600eaf6706e5b45a809135aa84292866b4b0dcd)
