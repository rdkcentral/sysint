...
#### [2.2.0v6](https://github.com/rdkcentral/sysint/compare/2.2.0v6...2.2.0v5)

- RDKEMW-7306: Delay observed with Critical Upgrade Event based Reboot event after doCDL event (#280)
- DELIA-68754: Update The Periodic Logging To Messages.log (#276)

#### [2.2.0v5](https://github.com/rdkcentral/sysint/compare/2.2.0v5...2.2.0v4)
- RDKEMW-5386 Possible update needed for disableUSBEthernet.sh as Hisense V1 supports two wifi chips #202
#### [2.2.0v4](https://github.com/rdkcentral/sysint/compare/2.2.0v4...2.2.0v3)
- XIONE-17460: FREE_MEM and USED_MEM logs are not reporting in messages log
#### [2.2.0v3](https://github.com/rdkcentral/sysint/compare/2.2.0v3...2.2.0v2)
- RDKEMW-7177: Update logrotate.service as timer based #262
#### [2.2.0v2](https://github.com/rdkcentral/sysint/compare/2.2.0v2...2.2.0)
- Update rebootNow.sh #223
