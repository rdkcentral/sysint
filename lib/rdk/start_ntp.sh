Gitiles
Code Review
Muthukrishnan, Sindhuja
Sign Out
gerrit.teamccp.com / rdk / rdkb / components / opensource / ccsp / Utopia / generic / refs/changes/66/917466/12 / . / source / scripts / init / service.d / service_ntpd.sh
blob: e96487b9e6b1987a1468cbca90bdf3803a7e6f58 [file] [log] [blame]
#!/bin/sh
##########################################################################
