...
MEMORY_LOG="/opt/logs/unified-logging.txt"
...
echo $(/bin/timestamp) "$1 process is not listed to upload, we are not processing the core file" >> $LOG_PATH/unified-logging.txt
